...
if opcion==1:
    precio=1.50
     ...
     print("Lo sentimos en el Carbonero no ofrecemos ese tipo de hamburguesas")
     print("Diguite una opcion valida")
...
if pago == 1:
    ...
    print("Su pago es en efectivo, por favor cancele su pedido sin recarga:", subtotal)
else:
